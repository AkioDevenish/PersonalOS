...
enum Metrics {
    ...
    static let all: [MetricSpec] = [
        ...
        .init(id: "distance", label: "Distance", group: .activity, unit: "km", precision: 2, cumulative: true, phrase: "walking and running distance", symbol: "location") { $0.distanceKm },
        .init(id: "flights", label: "Flights", group: .activity, unit: "", precision: 0, cumulative: true, phrase: "flights climbed", symbol: "figure.stairs") { $0.flightsClimbed },
        ...
        .init(id: "basal_energy", label: "Basal energy", group: .activity, unit: "kcal", precision: 0, cumulative: true, phrase: "resting energy", symbol: "bolt") { $0.basalEnergyBurned },
        .init(id: "daylight", label: "Daylight", group: .activity, unit: "min", precision: 0, cumulative: true, phrase: "time in daylight", symbol: "sun.max") { $0.timeInDaylight },

        // — Mobility & gait —
        .init(id: "walking_speed", label: "Walking speed", group: .gait, unit: "km/h", precision: 2, phrase: "walking speed", symbol: "speedometer") { $0.walkingSpeedKmh },
        .init(id: "steadiness", label: "Steadiness", group: .gait, unit: "%", precision: 0, phrase: "walking steadiness", symbol: "figure.walk.motion") { $0.walkingSteadiness.map { $0 * 100 } },
        .init(id: "asymmetry", label: "Asymmetry", group: .gait, unit: "%", precision: 1, phrase: "walking asymmetry", symbol: "arrow.left.arrow.right") { $0.walkingAsymmetryPct.map { $0 * 100 } },
        .init(id: "step_length", label: "Step length", group: .gait, unit: "m", precision: 2, symbol: "ruler") { $0.walkingStepLength },
        .init(id: "double_support", label: "Double support", group: .gait, unit: "%", precision: 1, phrase: "double support time", symbol: "shoeprints.fill") { $0.walkingDoubleSupportPct.map { $0 * 100 } },
        .init(id: "stair_speed", label: "Stair speed", group: .gait, unit: "m/s", precision: 2, phrase: "stair-climbing speed", symbol: "arrow.up.forward") { $0.stairAscentSpeed },

        // — Recovery & environment —
        .init(id: "sleep", label: "Sleep", group: .recovery, unit: "hrs", precision: 1, symbol: "moon.stars", value: sleep),
        .init(id: "resting_hr", label: "Resting HR", group: .recovery, unit: "bpm", precision: 0, phrase: "resting heart rate", symbol: "heart") { $0.restingHeartRate },
        .init(id: "mindful", label: "Mindfulness", group: .recovery, unit: "min", precision: 0, cumulative: true, phrase: "mindful minutes", symbol: "brain.head.profile") { $0.mindfulSessionMins },
        .init(id: "audio", label: "Audio exposure", group: .recovery, unit: "dB", precision: 0, phrase: "headphone audio exposure", symbol: "ear") { $0.headphoneAudioExposure },

        // — Metabolic —
        .init(id: "glucose", label: "Blood glucose", group: .metabolic, unit: "mg/dL", precision: 0, phrase: "blood glucose", symbol: "drop") { $0.avgBloodGlucoseMgdl },
